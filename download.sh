...
# usage: wget -qO- https://raw.githubusercontent.com/distributedweb/dweb-climaster/bin/install.sh | bash
# based on https://github.com/jpillora/installer/blob/master/scripts/download.sh

DAT_DIR="$HOME/.dweb/releases"
...
function install {
  ...
  *) fail "unsupported os: $(uname -s)";;
  ...
  LATEST=$($GET -qs https://api.github.com/repos/distributedweb/dweb-clireleases/latest | grep tag_name | head -n 1 | cut -d '"' -f 4);
